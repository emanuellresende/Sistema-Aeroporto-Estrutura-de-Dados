...
void DFS_Routh(TypeGraphMatriz *rotas, Aeroporto *aeroporto, int inicial,int origem, int destino, int paradas, int tamanho, int *guardar_rotas);void mostrar_voo_semconaxao(TypeGraphMatriz *rotas, int id, Tipo_Voo *voo, Aeroporto *aeroporto);
#endif